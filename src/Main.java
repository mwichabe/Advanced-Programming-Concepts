class Main {
    ...
    Electric electricCar = new Electric("Tesla", "Model 3", 2023, 4, 315, 82, 10);
    ...
    System.out.println("Number of Doors: " + electricCar.getNumberOfDoors());
    System.out.println("Driving Range: " + electricCar.getRange());
    System.out.println("Battery Capacity: " + electricCar.getBatteryCapacity());
    System.out.println("Battery Charge Time: " + electricCar.getBatteryChargeTime());
